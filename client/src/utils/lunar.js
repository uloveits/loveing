 ...
 */
  ...
  function lunarToSolar(date){
    ...
    let __month = offDate.getMonth()+1;
    return offDate.getFullYear() + '-' + __month + '-'+ offDate.getDate()
  };
  ...
  function solarToLunar(date){
    ...
    return {
      text: res.GanZhiYear + ' ' + res.zodiac + '年' + res.lunarMonthName + res.lunarDayName,
      num: res.lunarYear + '-' + res.lunarMonth + '-' + res.lunarDay
    }
  };
